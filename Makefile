...
docker-test:
	...
	docker exec -it kafka kafka-console-consumer --bootstrap-server kafka:9092 --topic hztest --consumer.config /etc/kafka/kafka-client.properties --from-beginning --max-messages 10
