...
docker exec -it kafka bash -c "cat /etc/passwd | kafka-console-producer --bootstrap-server kerberos.h100-smartai.com:54388 --topic hztest --producer.config /etc/kafka/kafka-client.properties"
